...
Service names
*/}}
{{- define "rustdesk.headlessServiceName" -}}
{{- printf "%s-headless" (include "rustdesk.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}

{{- define "rustdesk.hbbsServiceName" -}}
{{- printf "%s-hbbs" (include "rustdesk.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}

{{- define "rustdesk.hbbrServiceName" -}}
{{- printf "%s-hbbr" (include "rustdesk.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
